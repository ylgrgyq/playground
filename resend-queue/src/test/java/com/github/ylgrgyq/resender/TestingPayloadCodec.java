...
public class TestingPayloadCodec implements Codec<TestingPayload> {
    ...
    @Nonnull
    @Override
    public TestingPayload deserialize(@Nonnull byte[] bytes) throws DeserializationException {
    ...
    @Nonnull
    @Override
    public byte[] serialize(@Nonnull TestingPayload obj) throws SerializationException {

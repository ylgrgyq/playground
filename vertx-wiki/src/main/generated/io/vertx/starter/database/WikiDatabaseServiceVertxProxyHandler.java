...
public class WikiDatabaseServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "getIndex": {
          service.getIndex(HelperUtils.createHandler(msg));
          break;
        }
        case "getPage": {
          service.getPage((java.lang.String)json.getValue("pageName"),
        ...
        case "updatePage": {
          service.updatePage((java.lang.String)json.getValue("id"),
                        (java.lang.String)json.getValue("markdown"),
                        HelperUtils.createHandler(msg));
          break;
        }

...
public class NettyReplicatorServerBootstrap extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(NettyReplicatorServerBootstrap.class);
